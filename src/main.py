...
from src.Gui.PicButton import PicButton
...
class PdfConverter(PyQt5.QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.btn_pdf_split = self.create_btn_with_event('Split Pdf', partial(self.split_each_selected_pdf_into_two_pdfs, self.pdf_path_list, self.list_of_buttons), 450, 0)
        ...
        self.clear = self.create_btn_with_event('clear', self.clear_memory, 1000, 0)
        self.rotate_button = self.create_btn_with_event('rotate', self.rotate_pdf, 1300, 0)
    ...
    def pdf_to_jpeg(self, pdf_path_list):
        ...
        for pdf_path in pdf_path_list:
            ...
            for page_number, wand_image_jpeg in enumerate(wand_image_jpegs.sequence):
                ...
                self.list_of_images.append('Output/' + str(page_number) + ".jpeg")
